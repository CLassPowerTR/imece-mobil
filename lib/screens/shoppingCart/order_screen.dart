                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('360 TL', style: TextStyle(fontSize: 17)),
                    ],
                  ),
                  TextButton(
                    onPressed: () {},
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors
                                    .white, // İsteğe bağlı arka plan rengi
                                borderRadius: BorderRadius.circular(
                                  5,
                                ), // Köşe yuvarlaklığı 5
                                border: Border.all(
                    ...
                    boxShadow: [
                      BoxShadow(
                        ...
                        offset: Offset(
                          0,
                          4,
                        ), // X=0, Y=4 → Sadece aşağıya gölge ekler
                      ),
                    ],
                  ),
