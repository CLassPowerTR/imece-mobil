      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            textButton(
              context,
              widget.myProducts == true ? 'Ürünü Düzenle' : 'Ürün Detay',
              minSizeHeight: 38,
              elevation: 0,
              ...
              borderWidth: 1,
              onPressed: () {
                if (widget.myProducts == true) {
                  // TODO: Ürünü düzenle sayfasını aç
                  return;
                }
                final productId = widget.product.urunId;
                if (productId == null) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Ürün bilgisi bulunamadı.')),
                  );
                  return;
                }
                setState(() {
